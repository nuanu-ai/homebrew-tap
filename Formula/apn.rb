...
class Apn < Formula
  ...
  url "https://github.com/nuanu-ai/agent-payment-node/releases/download/v0.5.23/nuanu-ai-apn-0.5.23.tgz"
  sha256 "7c02760d592eeb3261d26ea0d97f413a1b8283f4b6ba9a9eca15bbd99ff7d7d2"
  license "MIT"
  ...
  test do
    assert_match '"product_version":"0.5.23"', shell_output("#{bin}/apn --version")
  end
end

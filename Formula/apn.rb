...
class Apn < Formula
  ...
  url "https://github.com/nuanu-ai/agent-payment-node/releases/download/v0.5.24/nuanu-ai-apn-0.5.24.tgz"
  sha256 "a0600ce47944ecb6230aba386243fbd3cbdb682b74e8a4c74d3a5f55b2238869"
  license "MIT"
  ...
  test do
    assert_match '"product_version":"0.5.24"', shell_output("#{bin}/apn --version")
  end
end
